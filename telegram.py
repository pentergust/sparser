...
TYPEHINT_MESSAGE = """
💡 Как писать заросы?
На самом дене всё намно-о-ого легче.
...
-- "матем" ➜ Вся математика не неделю.
-- "матем вторник 10а" ➜ Вы можете уточнить запрос классом и днём.

5. Укажите кабинет, чтобы увидеть расписание от его лица.
-- "328" ➜ Всё что проходит в 328 каибенете за неделю.
-- "312 литер вторник 7а" ➜ Можн уточнить классом, днём, уроком."""
