...
def cl_counter(sc: Schedule, intent: Intent
    ...
    :param sc: Экземпляр расписания для которого производится подсчёт.
    :type sc: Schedule
...
def days_counter(sc: Schedule, intent: Intent
    ...
    :param sc: Экземпляр расписания уроков для которого происход счёт.
    :type sc: Schedule
    :param intent: Намерения для уточнения результатов подсчёта.
    :type intent: Intent
...
def index_counter(
    ...
    :param sc: Экземпляр расписания уроков для которого происходи счёт.
    :type sc: Schedule
    :param intent: Намерения для уточнения результатов подсчёта.
    :type intent: Intent
