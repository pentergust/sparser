...
Для более удобной работа с расписанием.
Вы бы могли сохранять свои намерения в хранилище.
Это хранилище позволяет создавать, изменять, удалять намерения для
каждого пользователя платформы.
"""
...
class UserIntentsStorage:
    ...
    def get(self) -> list[IntentObject]:
        ...
        Возвращает готовый к рабоет список намерений пользователя.
    ...
    def rename(self, old_name: str, new_name: str) -> None:
        ...
        Обратите вниманиеЮ что не происходит никаких проверок.
